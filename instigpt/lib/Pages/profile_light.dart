...
class LightProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Profile'),
        backgroundColor: Colors.white, // Light app bar color
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ProfileField(
              ...
              label: "Name",
              value: name,
              textColor: Colors.black87, // Dark text for light mode
              iconColor: Colors.black87, // Dark icon color for light mode
            ),
            SizedBox(height: 10),
            ProfileField(
              icon: Icons.email,
              ...
              iconColor: Colors.black87, // Dark icon
            ),
            SizedBox(height: 10),
            ProfileField(
